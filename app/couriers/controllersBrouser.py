...
couriers_brouser_blu = Blueprint('brouser_couriers', __name__, url_prefix = '/brouser/couriers')
...
@couriers_brouser_blu.route('/singUpCourier', methods = ['GET', 'POST'])
def singUpCourier():
...
@couriers_brouser_blu.route('/login', methods = ['GET', 'POST'])
def loginCourier():
...
@couriers_brouser_blu.route('/logout', methods = ['GET', 'POST'])
def logOutCourier():
	logout_user()
	return redirect(url_for('couriers.getCourier'))

@couriers_brouser_blu.route('/<int:id>/profile')
@login_required
def getCourier(id):
...
@couriers_brouser_blu.route('/<int:id>/profile/edit', methods = ['GET', 'POST'])
@login_required
def editProfile(id):
	data = request.get_json(force = True)
	try:
...
@couriers_brouser_blu.route('/<int:id>/profile/editPhoto', methods = ['GET', 'POST'])
def editProfilePhoto(id):
	pass

@couriers_brouser_blu.route('/<int:id>/orders', methods = ['GET'])
def getOrders(id):
	courier = Courier.query.filter(Courier.id  ==  id).first()
...
couriers_brouser_blu.route('/<int:id>/orders/add', methods = ['GET', 'POST'])
def addOrder(id):
	data = request.get_json(force = True)
	courier = Courier.query.filter(Courier.id  ==  id).first()
...
couriers_brouser_blu.route('/<int:id>/orders/<int:id_order>/editStatus', methods = ['POST'])
...
couriers_brouser_blu.route('/<int:id>/operations', methods = ['GET'])
...
couriers_brouser_blu.route('/<int:id>/operations/withdrawalOfFunds', methods = ['POST'])
