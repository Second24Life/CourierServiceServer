...
managers_brouser_blu = Blueprint('brouser_managers', __name__, url_prefix = '/brouser/managers')
...
@managers_brouser_blu.route('/singUpManager', methods = ['GET', 'POST'])
def singUpManager():
...
@managers_brouser_blu.route('/login', methods = ['GET', 'POST'])
def loginManager():
...
@managers_brouser_blu.route('/logout', methods = ['GET', 'POST'])
def logOutManager():
	logout_user()
	return redirect(url_for('managers.getManagers'))

@managers_brouser_blu.route('/<int:id>/profile')
@login_required
def getManager(id):
...
@managers_brouser_blu.route('/<int:id>/profile/edit', methods = ['GET', 'POST'])
@login_required
def editProfile(id):
	data = request.get_json(force = True)
	try:
...
@managers_brouser_blu.route('/<int:id>/profile/editPhoto', methods = ['GET', 'POST'])
